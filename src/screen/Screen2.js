...
export default function Screen2({ navigation }) {
  ...
  const animation = useRef(new Animated.Value(-800)).current; // Start the image off-screen on the left
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>Awesome Experiance</Text>
      <Animated.Image
        source={require('../img/car.gif')}
        style={[
          styles.image,
          {
            transform: [
